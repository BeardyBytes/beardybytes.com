...
const toLineArrayString = (str) => {
  ...
  const base = lines.map((line) => `\`${line}\``).join(',')

  return `[${base}]`
}

const inlineFirstCommit = (content) => {
  const diffFirst = content.diffFirst ? `${toLineArrayString(content.diffFirst)}` : 'null'
  const diffPrevious = content.diffPrevious ? `${toLineArrayString(content.diffPrevious)}` : 'null'
      ...
      <div class="site">
        ...
        <div class="panel content-panel">
          <div class="panel side-panel">
            ...
            <div class="page active comments-page">
              <div class="page-content-wrapper">
                ...
                <p>
                  Here you find a detailed explanation of the changes made in the commit, as well as the process of
          ...
          <div class="panel code-panel">
            <div class="page active code-page"></div>
            <div class="page inactive diff-previous-page"></div>
            <div class="page inactive diff-first-page"></div>
          </div>
          <div class="clear"></div>
        </div>
        <div class="clear"></div>
...
const processCommits = (url, commits) =>
  commits.map(processCommit.bind(null, url)).reduce((acc, curr) => acc.concat(curr), [])
